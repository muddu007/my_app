            ...
            steps {
                    ...
                    script {
                        ...
                        env.ECS_SERVICE_NAME = sh(
                            script: "aws ssm get-parameter --name 'ecs_service_name_prod' --query 'Parameter.Value' --output text",
                            returnStdout: true
                        ).trim()
                        ...
                        env.ECS_CLUSTER_NAME = sh(
                            script: "aws ssm get-parameter --name 'ecs_cluster_name_prod' --query 'Parameter.Value' --output text",
                            returnStdout: true
                        ).trim()
                        ...
                        env.ECS_TASK_FAMILY = sh(
                            script: "aws ssm get-parameter --name 'ecs_task_family_prod' --query 'Parameter.Value' --output text",
                            returnStdout: true
                        ).trim()
                    }
                    }
